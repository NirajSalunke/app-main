        ...
        <div className="size-full max-w-2xl h-full flex flex-col items-center justify-center text-center overflow-hidden">
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <p className="text-7xl font-bold">
              Developed by <br />
              <span className="text-[#5046e6]">Vault Base</span>
            </p>
          </BoxReveal>
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <h2 className="mt-2 text-lg text-muted-foreground">PICT</h2>
          </BoxReveal>

          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-6 space-y-2 text-xs flex gap-5">
              <p>
                <a target="_blank" href="mailto:vaultbasesuper@gmail.com">
                  <img
                    alt="mail"
              ...
              <p>
                <a
                  target="_blank"
                  href="https://www.npmjs.com/package/create-vault"
                >
                  <img
                    alt="npm"
